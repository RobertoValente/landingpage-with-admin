...
import type { CtaContent } from "@/lib/db-cta"

type FormState = Omit<CtaContent, "id">

const FIELDS: { key: keyof FormState; label: string; hint?: string }[] = [
  { key: "heading", label: "Heading" },
  { key: "subtext", label: "Subtext" },
  { key: "footnote", label: "Footnote", hint: "Small text below the waitlist form" },
]
...
export function AdminCtaEditor() {
    ...
    <form onSubmit={handleSubmit} className="mx-auto max-w-2xl">
      <div className="rounded-xl border bg-background">
        <div className="border-b px-6 py-4">
          ...
          <p className="text-xs text-muted-foreground">The waitlist call-to-action above the footer</p>
        </div>
